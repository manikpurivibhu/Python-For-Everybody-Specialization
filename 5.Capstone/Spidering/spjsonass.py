...
conn = sqlite3.connect('spiderass.sqlite')
cur = conn.cursor()

print("Creating JSON output on spiderass.js...")
...
print("Open spiderforce.html in a browser to view the visualization")
